...
{
	setupHardware();
	xTaskCreate(ledTask1,"Task1",configMINIMAL_STACK_SIZE,NULL,3,&task_h1);			//Task1 --> LED
	xTaskCreate(ledTask2,"Task2",configMINIMAL_STACK_SIZE,NULL,2,&task_h2);			//Task2 --> LED
	xTaskCreate(ledTask3,"Task3",configMINIMAL_STACK_SIZE,NULL,1,&task_h3);			//Task3 --> LED	
